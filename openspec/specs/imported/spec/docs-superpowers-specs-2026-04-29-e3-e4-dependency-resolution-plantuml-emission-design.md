...
> Imported legacy SPEC artifact from `docs/superpowers/specs/2026-04-29-e3-e4-dependency-resolution-plantuml-emission-design.md`. Keep future lifecycle work in OpenSpec.
